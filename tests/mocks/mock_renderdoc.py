...
class ResourceFormat:
    ...
    def __init__(
        ...
        # ``name`` is retained as a mock-only constructor convenience. RenderDoc
        # 1.45 exposes the value through Name(), not as a public data field.
    ...
    def BGRAOrder(self) -> bool:
        return self._display_name.startswith("B")

    def SRGBCorrected(self) -> bool:
        return "SRGB" in self._display_name

    def Special(self) -> bool:
        return self.type != 0

    def BlockFormat(self) -> bool:
        return self._display_name.startswith("BC")
